...
function Draw-Header {
    ...
    Write-Host '|  Plugins:  t.me/lovesort                                   |' -ForegroundColor Cyan
    Write-Host '+------------------------------------------------------------+' -ForegroundColor Cyan
    Write-Host ''
}
...
function Start-Bot {
    ...
    python bot.py
    Write-Host ''
    Write-Host '  [ INFO ] Bot ostanovlen. Najmite ljubuju klavishu dlja vozvrata v menju.' -ForegroundColor Gray
...
function Check-Updates {
    ...
    python updater.py
    Write-Host ''
    Write-Host '  [ INFO ] Proverka zavershena. Najmite ljubuju klavishu.' -ForegroundColor Gray
    [void][System.Console]::ReadKey($true)
}
...
function Create-Release {
    ...
    Write-Host ''
    Write-Host '  [ INFO ] Operacija zavershena. Najmite ljubuju klavishu.' -ForegroundColor Gray
    [void][System.Console]::ReadKey($true)
}

function Open-Folder {
    explorer $PSScriptRoot
    Write-Host '  [ INFO ] Papka otkryta. Najmite ljubuju klavishu.' -ForegroundColor Gray
    [void][System.Console]::ReadKey($true)
}
